        ...
        <div className="flex items-center justify-between gap-2 border-t border-white/[0.08] bg-white/[0.03] px-5 py-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={cn(
                "inline-flex items-center gap-1.5 whitespace-nowrap rounded-md bg-brand px-4 py-2 text-sm font-semibold text-navy-900 transition-colors hover:bg-brand/100",
