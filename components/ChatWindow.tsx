                ...
                <li key={c.id}>
                  ...
                  >
                    ...
                    <span className={cn(
                      ...
                      c.role === "SUPPLIER" ? "bg-accent-600 text-white ring-accent-600/20" : "bg-brand/10 text-brand-700 ring-brand/25",
                    )}>
            ...
            <div className="flex items-center gap-3 border-b border-slate-200 bg-white px-4 py-3">
              ...
              <span className="relative shrink-0">
                <span className={cn(
                  ...
                  activeCompany.role === "SUPPLIER" ? "bg-accent-600 text-white" : "bg-brand/10 text-brand-700",
                )}>
            ...
            <div className="border-t border-slate-200 bg-white p-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="h-11 min-w-0 flex-1 rounded-xl border border-slate-200 bg-slate-50 px-4 text-sm text-slate-900 placeholder:text-slate-400 outline-none focus:border-brand/50 focus:bg-white"
                />
