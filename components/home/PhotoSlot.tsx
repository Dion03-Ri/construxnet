...
export default function PhotoSlot({
  ...
  return (
    ...
    >
      <span className="text-[10px] font-bold uppercase tracking-[0.16em] text-white/[0.56]">
        Bildplatz
      </span>
      <div>
        <p className="text-[12.5px] font-semibold leading-snug text-white/[0.72]">{slot.alt}</p>
        <p className="mt-1.5 text-[11px] leading-relaxed text-white/[0.56]">Suche: {slot.search}</p>
      </div>
    </div>
  );
}
