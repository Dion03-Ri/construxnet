    ...
    <div className="space-y-4">
      ...
      {loading ? (
        ...
        <div className={"border-t border-white/[0.12] py-16 text-center"}>
          <Package className="mx-auto h-8 w-8 text-white/[0.4]" />
        ...
        <div className="space-y-3">
          {mine.map((m) => {
            ...
            return (
              <div key={m.id} className={"border-t border-white/[0.12] py-5 transition-colors hover:bg-white/[0.02]"}>
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <div className="min-w-0">
                    <h3 className="text-[14.5px] font-bold text-white">{m.label}</h3>
                    <p className="mt-0.5 flex flex-wrap items-center gap-x-2.5 text-[12.5px] text-white/[0.72]">
                    ...
                    {m.sia && (
                      <p className="mt-0.5 truncate text-[11.5px] text-white/[0.56]">{m.sia}</p>
                    )}
                  </div>
                  <span
                    className={cn(
                ...
                {m.status === "MERGED" && m.merged_into && (
                  <p className="mt-2 text-[12.5px] text-white/[0.72]">
                    Aufgegangen in{" "}
...
function MergeModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg overflow-hidden rounded-xl border border-white/[0.12] bg-[#16181a] shadow-2xl">
        ...
        <div className="space-y-3 px-5 py-4">
          ...
          <ul className="max-h-64 overflow-y-auto rounded-md border border-white/[0.12]">
            {results.map((m) => (
              <li key={m.id}>
                <button
                  type="button"
                ...
                >
                  <span className="min-w-0">
                    ...
                    <span className="block font-mono text-[10.5px] text-white/[0.56]">{m.id}</span>
                  </span>
