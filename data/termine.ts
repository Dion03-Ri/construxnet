...
export const TERMINE: Termin[] = [
  { id: "t1", title: "Sammelphase-Ende · Beton C25/30 Limmattal", type: "Pool-Deadline", inDays: 2, hour: 12, durationH: 1, region: "Zürich", location: "Online / Obtanet", description: "Letzter Beitritt zum Beton-Pool bevor die Sealed-Bid-Phase startet. Aktuelles Volumen 230 m³.", href: "/pools" },
  { id: "t2", title: "Sealed-Bid Zuschlag · Wandkies Nordwestschweiz", type: "Sealed-Bid", inDays: 1, hour: 10, durationH: 1, region: "Nordwestschweiz", location: "Online / Obtanet", description: "Verbindliche Angebotsabgabe der Lieferanten; günstigster Bid ggü. KBOB erhält den Zuschlag.", href: "/pools" },
  ...
  { id: "t5", title: "Sammelphase-Ende · Dämmung EPS 034 Ostschweiz", type: "Pool-Deadline", inDays: 8, hour: 12, durationH: 1, region: "Ostschweiz", location: "Online / Obtanet", description: "Pool für 3'000 m² Dämmung — noch offen für weitere Teilnehmer.", href: "/pools" },
