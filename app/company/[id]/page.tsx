  ...
  return (
    <main className={cn(SHELL_NARROW, "py-6")}>
      ...
      {/* Profil-Kopf.
          ...
          Deckstreifen. Ein Verlauf, der nichts zeigt, ist Dekoration —
          und Deckstreifen mit Verlauf sind das Erkennungszeichen jeder
          erzeugten Profilseite. Jetzt eine ruhige Navyfläche, auf der
          Name, Rolle und UID stehen, darunter das weisse Blatt.

          Die Beschaffung trägt ein Navyband, „Profil bearbeiten" ein
        ...
        <div className="px-6 pb-9 sm:px-9">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div className="min-w-0">
              ...
              {company.verified && (
                <span className="mt-3 inline-flex items-center gap-1.5 text-[11px] font-semibold uppercase tracking-[0.12em] text-brand">
            ...
            {isMe ? (
              <Link
                href="/profile/edit"
                className="inline-flex shrink-0 items-center gap-1.5 rounded-md bg-brand px-4 py-2 text-sm font-semibold text-navy-950 transition-colors hover:bg-brand-600"
              >
